...
public class DatabaseInitializer implements InitializingBean {
    ...
    public static List<TourEntity> getInitialDemoData() {
        ...
        tourList.add(TourEntity.builder().id(5L).name("John").build());
        tourList.add(TourEntity.builder().id(7L).name("Albert").build());
        tourList.add(TourEntity.builder().id(11L).name("Monica").build());
        return tourList;
    }
